...
wandb.init(project="code-llama-finetuning", 
           name=f"fine-tune-semantic-length-generalization-desc_{timestamp}",
...
# Input-Experiment 3: Description
dataset = load_dataset("ruthchy/semantic-length-generalization-logo-data-desc")
...
training_args = TrainingArguments(
    ...
    report_to=["wandb"],
    hub_model_id="ruthchy/03_expt_code-llama-desc", 
    push_to_hub=True,
    logging_steps = 1,
)
...
wandb.log({"Experiment 3 Results": results})
print("Experiment 3 Results:", results)